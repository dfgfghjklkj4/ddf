...
namespace AwesomeTechnologies.Shaders
{
    public class StylizedGrassShaderController : IShaderController
    {
        ...
        public void CreateDefaultSettings(Material[] materials)
        {
            ...
            Settings.AddBooleanProperty("fadeInvert", "Fade invert", "", fadeParams.w == 1f);
            ...
            Settings.AddFloatProperty("_Translucency", "Translucency (Direct)", "", ShaderControllerSettings.GetFloatFromMaterials(materials, "_Translucency"), 0, 1);
            ...
            Settings.AddFloatProperty("_NormalsFlatten", "Flatten normals (lighting)", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").x, 0, 1);
            Settings.AddFloatProperty("_NormalsSpherify", "Spherify normals", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").y, 0, 1);
            Settings.AddFloatProperty("_NormalsSpherifyMask", "Tip mask", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").z, 0, 1);
            Settings.AddFloatProperty("_NormalsFlattenDepth", "Flatten normals (geometry)", "", ShaderControllerSettings.GetVector4FromMaterials(materials, "_NormalParams").w, 0, 1);
        ...
        public void UpdateMaterial(Material material, EnvironmentSettings environmentSettings)
        {
            ...
            material.SetVector("_FadeParams", new Vector4(
                ...
                Settings.GetBooleanPropertyValue("fadeInvert") ? 1f : 0f));
            ...
            material.SetVector("_NormalParams", new Vector4(
                Settings.GetFloatPropertyValue("_NormalsSpherify"),
                Settings.GetFloatPropertyValue("_NormalsFlatten"),
                Settings.GetFloatPropertyValue("_NormalsSpherifyMask"),
                Settings.GetFloatPropertyValue("_NormalsFlattenDepth")
                ));
